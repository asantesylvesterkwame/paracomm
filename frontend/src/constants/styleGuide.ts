...
export const COMPONENT_PATHS: ComponentPath[] = [
  ...
  { path: "src/components/common/CallButton.tsx", role: "Starts a video call from a conversation header" },
  { path: "src/components/common/CallEntry.tsx", role: "Centered call record inside the message thread" },
